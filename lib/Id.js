...
Id.sum = function(a, b) {
  return (a instanceof ZeroId && b instanceof ZeroId) ? new ZeroId()
    : (a instanceof OneId && b instanceof OneId) ? new OneId()
    : (a instanceof OneId) ? new OneId()
    : (b instanceof OneId) ? new OneId()
    : (a instanceof ZeroId) ? b.clone()
    : (b instanceof ZeroId) ? a.clone()
    : (new Id(Id.sum(a.left, b.left),
      Id.sum(a.right, b.right))).norm()
}
